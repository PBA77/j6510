...
opcodes and addressing modes of the original NMOS 6502 CPU. The interrupt test
requires a feedback register to inject IRQ and NMI requests; this project wires
that behavior only in `tests/klaus_interrupt_main.cpp`, not in the CPU core.
